...
public class OpenExit extends State {
    ...
    public OpenExit(StateMachineComponent sm, GameObject gameObject, TileType t) {
        this.sm = sm;
        this.gameObject = gameObject;
        this.image = new SpriteComponent(gameObject, HelpMeImageResource.images.getResource(t.name()), new Vec2d(1,0));
        this.t = t;
    }
    ...
    public void onSwitch() {
        if (!HelpMeGame.doorOpen) {
            sm.setCurrentState(new ClosedExit(sm, gameObject, t));
        }
    }

...
public class IdleStateLeftPlayer extends State {
    ...
    SpriteComponent idle;
     ...
     public IdleStateLeftPlayer(StateMachineComponent sm, GameObject gameObject) {
         ...
         this.idle = new SpriteComponent(gameObject, WizGame.images.getResource(TileType.PLAYER1.name()), new Vec2d(0,2));
     }
    ...
    public void onSwitch() {
        ...
        if (c1.isOnceHappened()) {
            ...
            if (directionShoot == Direction.UP) {
                ...
                sm.setCurrentState(new ShootStateLeftDownPlayer(sm, gameObject));
            }  else {
                assert false;
            }
        }
